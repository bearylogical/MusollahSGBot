        ...
        try {
            ...
            switch (body.toLowerCase()) {
                ...
                if (musollahSession.onGoing) {
                    return (musollahSessions[chatId] = musollah.musollahQuery(chatId, body.toLowerCase(), msg.location, bot));
                }

                if (SGmusollahSession.onGoing) {
                    return (SGmusollahSessions[chatId] = sgmusollah.SGmusollahLocator(chatId, msg.location, bot));
                }
    ...
    function processLocation(msg) {
        ...
        if (musollahSession.onGoing) {
            console.log("there");
            return (musollahSessions[chatId] = musollah.musollahQuery(chatId, msg.text, msg.location, bot));
        }
        if (SGmusollahSession.onGoing) {
            return (SGmusollahSessions[chatId] = sgmusollah.SGmusollahLocator(chatId, msg.location, bot));
        } else {
